...
var SmtpService = /*#__PURE__*/function (_NotificationService) {
  _inherits(SmtpService, _NotificationService);
  var _super = _createSuper(SmtpService);
  /**
   ...
   */
  function SmtpService(_ref, options) {
    var _this;
    ...
    _this.transporter = _nodemailer["default"].createTransport(_this.options_.transport);
    return _this;
  }
  _createClass(SmtpService, [{
      ...
      var _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event, eventData, attachmentGenerator) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 16:
              return _context2.abrupt("return", this.inviteData(eventData, attachmentGenerator));
            case 17:
              _context2.next = 19;
    ...
    key: "getTemplateNameForEvent",
    value: function getTemplateNameForEvent(eventName) {
    ...
    value: function () {
      var _sendNotification = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event, eventData, attachmentGenerator) {
        var templateName, data, attachments, sendOptions, email, status;
          ...
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 8:
              ...
              if (attachments !== null && attachments !== void 0 && attachments.length) {
                sendOptions.message.attachments = attachments.map(function (a) {
                  return {
                    content: a.base64,
                    filename: a.name,
                    type: a.type,
              ...
              email = new _emailTemplates["default"]({
                message: {
              ...
              _context3.next = 14;
              return email.send(sendOptions).then(function () {
                return 'sent';
              })["catch"](function () {
                return 'failed';
              });
    ...
    value: function () {
      var _resendNotification = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(notification, config, attachmentGenerator) {
        var templateName, sendOptions, attachments, email, status;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              templateName = this.getTemplateNameForEvent(notification.event_name);
              if (templateName) {
                _context4.next = 3;
                break;
              }
    ...
    key: "inviteData",
    value: function inviteData(data) {
...
_defineProperty(SmtpService, "identifier", 'smtp');
var _default = SmtpService;
