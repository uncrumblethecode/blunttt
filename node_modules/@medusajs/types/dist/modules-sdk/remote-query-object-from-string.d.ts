...
export type RemoteQueryInput<TEntry extends string> = TEntry extends keyof RemoteQueryEntryPoints ? {
    /**
     ...
     */
    fields: ObjectToRemoteQueryFields<RemoteQueryEntryPoints[TEntry]> extends never ? string[] : ObjectToRemoteQueryFields<RemoteQueryEntryPoints[TEntry]>[] | string[];
    /**
     ...
     * The fields and relations to retrieve in the entity.
     */
    fields: ObjectToRemoteQueryFields<any> extends never ? string[] : ObjectToRemoteQueryFields<any>[] | string[];
    /**
     * Pagination configurations for the returned list of items.
     */
    pagination?: {
