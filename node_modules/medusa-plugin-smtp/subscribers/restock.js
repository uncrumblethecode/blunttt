...
var RestockNotification = /*#__PURE__*/_createClass(function RestockNotification(_ref) {
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(eventData) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return smtpService.getTemplateNameForEvent('restock-notification.restocked');
          case 2:
            templateName = _context2.sent;
            if (templateName) {
              _context2.next = 5;
              break;
            }
          ...
          case 5:
            _context2.next = 7;
            return smtpService.fetchData('restock-notification.restocked', eventData, null);
          case 7:
            data = _context2.sent;
            if (data.emails) {
              _context2.next = 10;
                ...
                return _regeneratorRuntime().wrap(function _callee$(_context) {
                  while (1) switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _context.next = 3;
                      return smtpService.sendEmail(sendOptions);
                    case 3:
