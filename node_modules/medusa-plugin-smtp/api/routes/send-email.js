...
var _default = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var schema, _schema$validate, value, error, smtpService;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          _context.prev = 4;
          smtpService = req.scope.resolve("smtpService");
          _context.next = 8;
          return smtpService.sendEmail(value.template_id, value.from, value.to, value.data);
        case 8:
          res.sendStatus(200);
          _context.next = 14;
          break;
